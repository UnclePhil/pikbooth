...
app.get('/', function (req, res) {
  pictures = fs.readdirSync(config.save.dir).reverse().slice(config.client.limit);
...
app.get('/booth', function (req, res) {
  pictures = fs.readdirSync(config.save.dir).reverse().slice(config.booth.limit);
...
app.get('/cmd', function (req, res) {
  pictures = fs.readdirSync(config.save.dir).reverse().slice(config.cmd.limit);
